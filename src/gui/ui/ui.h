...
namespace ui {
	...
	struct RenderHistoryEntryElementData {
		...
		bool error;                                 // failed renders get their own colours
	...
	// render history rows keep their contents this far in from their edges, with action buttons this big down the
	// right. the history button lines itself up with that column
	...
	// one row of the render history: thumbnail, title, a detail line or two and its action buttons
